...
<button class="windowButton minimizeButton"><img class="controlButtons" src="images/logos/windowIcons/minimizeIcon.png"/></button>
<button class="windowButton fullscreenButton"><img class="controlButtons" src="images/logos/windowIcons/FullscreenIcon.png"/></button>
<button class="windowButton closeButton"><img class="controlButtons" src="images/logos/windowIcons/closeIcon.png"/></button>
...
<div class="resize-handle" id="resizeBottomRight"></div>
    ...
    if (img) {
        ...
        $('#open').append(`<button class="showWindow" id="`+windowAmmount+`"><img id="`+windowAmmount+`" src="../images/logos/defaultApplication.png"/></button>`);
    }
    windowData();
    windowAmmount++;
}
